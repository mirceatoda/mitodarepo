...
setup(
    ...
    name = "packageName", # same as template name
    author = "Dummy User",
    author_email = "<CEC_userid>@cisco.com", # if author is supplied author_email is mandatory too
    url = "http://my-home-page.example.com",

    # OPTIONAL fields (see https://docs.python.org/2/distutils/setupscript.html for more)
    long_description = long_description,
    # version = "1.0.0" # if not supplied default will be 0.0.0
